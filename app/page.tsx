    ...
    <div style={{ background: '#F5F2EC', fontFamily: 'var(--font-playfair)' }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 2, textAlign: 'center', padding: '0 20px' }}>
          <div style={{ fontFamily: 'var(--font-inter)', fontSize: '10px', color: 'rgba(255,255,255,0.5)', letterSpacing: '0.2em', textTransform: 'uppercase' as const, marginBottom: '28px', display: 'flex', alignItems: 'center', gap: '14px' }}>
            <div style={{ width: '32px', height: '0.5px', background: 'rgba(255,255,255,0.4)' }} />
            Prestigious Trading Club · Est. 2025
            <div style={{ width: '32px', height: '0.5px', background: 'rgba(255,255,255,0.4)' }} />
          </div>

          <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: '110px', fontWeight: '700', lineHeight: '0.9', letterSpacing: '-4px', margin: '0 0 6px', color: '#ffffff' }}>FLOW</h1>
          <div style={{ width: '180px', height: '3px', background: '#2B5EA7', margin: '0 auto 14px' }} />
          <p style={{ fontFamily: 'var(--font-playfair)', fontStyle: 'italic', fontSize: '20px', color: 'rgba(255,255,255,0.8)', letterSpacing: '5px', margin: '0 0 36px' }}>Capitals.</p>

          <p style={{ fontFamily: 'var(--font-playfair)', fontStyle: 'italic', fontSize: '21px', color: '#ffffff', lineHeight: '1.6', maxWidth: '600px', margin: '0 0 10px' }}>
            &ldquo;Years of failure. Every euro saved. Every mistake made twice.
          </p>
          <p style={{ fontFamily: 'var(--font-playfair)', fontStyle: 'italic', fontSize: '21px', color: '#7aaee8', lineHeight: '1.6', maxWidth: '600px', margin: '0 0 48px' }}>
            This is what it took to find the blueprint. Now it is yours.&rdquo;
          </p>

          <div style={{ display: 'flex', gap: '14px' }}>
            <a href="/method" style={{ background: '#2B5EA7', color: '#ffffff', fontFamily: 'var(--font-inter)', fontSize: '11px', letterSpacing: '0.12em', textTransform: 'uppercase' as const, padding: '15px 36px', textDecoration: 'none', fontWeight: '700', transition: 'all 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.background = '#1a4a8f'}
              onMouseLeave={e => e.currentTarget.style.background = '#2B5EA7'}
            >SEE THE ROADMAP →</a>
            <a href="/discovery" style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.35)', color: '#ffffff', fontFamily: 'var(--font-inter)', fontSize: '11px', letterSpacing: '0.12em', textTransform: 'uppercase' as const, padding: '14px 32px', textDecoration: 'none', transition: 'all 0.2s' }}
        ...
        <div style={{ position: 'absolute', bottom: '48px', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: '80px', zIndex: 2 }}>
          {[['$100K+', 'Certified Payouts'], ['25', 'Age of Founder'], ['3+', 'Years in the Market']].map(([val, lbl]) => (
            <div key={lbl} style={{ textAlign: 'center' }}>
              <div style={{ fontFamily: 'var(--font-playfair)', fontSize: '34px', fontWeight: '600', color: '#ffffff', lineHeight: 1 }}>{val}</div>
              <div style={{ fontFamily: 'var(--font-inter)', fontSize: '9px', letterSpacing: '0.14em', textTransform: 'uppercase' as const, color: 'rgba(255,255,255,0.4)', marginTop: '6px' }}>{lbl}</div>
            </div>
          ))}
        </div>
      </section>
    ...
    <div style={{ padding: '80px', display: 'flex', flexDirection: 'column' as const, justifyContent: 'center' }}>
      ...
      <section style={{ padding: '100px 80px', background: '#F5F2EC', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'var(--font-playfair)', fontStyle: 'italic', fontSize: '28px', color: '#1a1a1a', lineHeight: '1.6', marginBottom: '28px' }}>
      ...
      <section style={{ padding: '80px', background: '#1a2a4a', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: '36px', fontWeight: '700', color: '#ffffff', marginBottom: '8px' }}>Ready to start your journey?</h2>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <a href="/method" style={{ background: '#2B5EA7', color: '#ffffff', fontFamily: 'var(--font-inter)', fontSize: '11px', letterSpacing: '0.12em', textTransform: 'uppercase' as const, padding: '14px 32px', textDecoration: 'none', fontWeight: '700', transition: 'all 0.2s' }}
            onMouseEnter={e => e.currentTarget.style.background = '#1a4a8f'}
            onMouseLeave={e => e.currentTarget.style.background = '#2B5EA7'}
          >Our Method →</a>
          <a href="/membership" style={{ background: 'none', border: '1px solid rgba(255,255,255,0.25)', color: '#ffffff', fontFamily: 'var(--font-inter)', fontSize: '11px', letterSpacing: '0.12em', textTransform: 'uppercase' as const, padding: '13px 28px', textDecoration: 'none', transition: 'all 0.2s' }}
